const notes = [
    ...
    { id: 'CN', name: 'CSS Notes', color: 'orange', content: [] },
    { id: 'SN', name: 'SQL Notes', color: 'blue', content: [] },
    { id: 'PN', name: 'Python Notes', color: 'purple', content: [] },
    { id: 'ZP', name: 'New Notes', color: 'aqua', content: [] }
];
